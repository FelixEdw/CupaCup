...
const { getProfile, updateProfile, toggleFollow, searchUsers, getFollowers, getFollowing, getCreators, getNotifications } = require('../controllers/userController');
...
router.get('/creators', optAuth, getCreators);
