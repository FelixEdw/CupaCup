...
const { getFeed, getPublicFeed, getNotesFeed, getFollowingFeed, getUserPosts, getPost, createPost, toggleLike, repost, toggleSave, getSavedPosts, getRepostedPosts, deletePost, getTrendingTags } = require('../controllers/postController');
